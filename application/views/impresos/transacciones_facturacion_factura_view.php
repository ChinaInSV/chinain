<?php
	...
	$phpPrinter->printString($phpPrinter->cutString(utf8_decode('Comprobante de Factura No '.$doc_numero),28),1,$printer,$acum,$tabheight_letter,$tabwidth_letter);
	...
	$phpPrinter->printString($phpPrinter->cutString(strtoupper(utf8_decode('Dir: '.$direccion_cliente)),28),1,$printer,$acum,$tabheight_letter,$tabwidth_letter);
	endif;
	if($telefono_cliente!=""):
	$phpPrinter->printString($phpPrinter->cutString(strtoupper(utf8_decode('Tel: '.$telefono_cliente)),28),1,$printer,$acum,$tabheight_letter,$tabwidth_letter);
	endif;
	$phpPrinter->tabPrinter($acum,$tabwidth_letter);
